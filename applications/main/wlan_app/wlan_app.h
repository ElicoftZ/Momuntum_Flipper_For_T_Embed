...
struct WlanApp {
    ...
    // with a captive-portal popup (like hotel/airport WiFi) serving one
    // read-only page, for demos/pranks with no credential capture. Both
    // persisted separately from webfs_ssid/pw above.
